document.addEventListener('DOMContentLoaded', () => {
  ...
  const profileEmail = document.querySelectorAll(
    '.profile-card .d-flex.align-items-center span.small'
  )[0];
  const profilePhone = document.querySelectorAll(
    '.profile-card .d-flex.align-items-center span.small'
  )[1];
  const profileLocation = document.querySelectorAll(
    '.profile-card .d-flex.align-items-center span.small'
  )[2];
    ...
    fetch(`${API_URL}/users/id-user/${userId}`, {
      ...
      .then((user) => {
        ...
        profileLocation.textContent =
          ubicacion !== ', ' ? ubicacion : 'Agrega tu ubicación';
        ...
        profileDesc.textContent =
          localDesc ||
          '¡Hola!... ¿Eres nuevo en PetMe?... Agrega una descripción';
  ...
  function cargarMisPublicaciones() {
    if (!userId || !token) {
      container.innerHTML =
        '<p class="text-center text-danger">Inicia sesión.</p>';
      return;
    }
                        ...
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <h5 class="font-display fw-bold mb-2">${
                                      pub.titulo
                                    }</h5>
                                    ${botonAccion}
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    <span class="badge bg-light text-dark border">❤️ ${
                                      pub.likes || 0
                                    } Likes</span>
                                </div>
                            </div>
